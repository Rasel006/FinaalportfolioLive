const loadTechStack = () => {
    fetch("https://mdraselportfolioapi.onrender.com/skills/list/")
      .then((res) => res.json())
...
const FilterCateogry = (id) => {
  fetch(`https://mdraselportfolioapi.onrender.com/project/list/?category_id=${id}`)
    .then((res) => res.json())
...
function resumeDownLoad() {
  ...
  const apiLink = "https://mdraselportfolioapi.onrender.com/media/Skills/resumes/Md Rasel.pdf";
  ...
  downloadLink.download = "Md Rasel.pdf";
...
const loadProject = () => {
  fetch("https://mdraselportfolioapi.onrender.com/project/list/")
    .then((res) => res.json())
    .then((data) => displayProject(data.results))
    .catch((err) => console.log(err));
};
...
function uploadImage() {
  ...
  fetch("https://mdraselportfolioapi.onrender.com/user/images/", {
    method: "POST",
